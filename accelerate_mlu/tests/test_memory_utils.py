...
from accelerate.test_utils import require_mlu
...
class MemoryTest(unittest.TestCase):
    ...
    def test_release_memory(self):
        starting_memory = torch.mlu.memory_allocated()
        model = ModelForTest()
        model.mlu()
        self.assertGreater(torch.mlu.memory_allocated(), starting_memory)
        model = release_memory(model)
        self.assertEqual(torch.mlu.memory_allocated(), starting_memory)
