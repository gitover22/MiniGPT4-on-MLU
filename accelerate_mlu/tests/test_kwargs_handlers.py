...
from accelerate.test_utils import execute_subprocess_async, require_mlu, require_multi_gpu
...
class DataLoaderTester(unittest.TestCase):
    ...
    def test_ddp_kwargs(self):
        ...
        cmd += [f"--nproc_per_node={torch.mlu.device_count()}", inspect.getfile(self.__class__)]
