...
from accelerate.test_utils import require_mlu, require_mps, require_multi_gpu, require_torch_min_version, slow
...
class BigModelingTester(unittest.TestCase):
    ...
    @require_mlu
    def test_init_on_device_mlu(self):
    ...
    def test_cpu_offload(self):
        ...
        device = torch.device(0 if torch.mlu.is_available() else "cpu")
