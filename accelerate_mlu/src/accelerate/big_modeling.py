...
def cpu_offload_with_hook(
    ...
    ```py
    model_1, hook_1 = cpu_offload_with_hook(model_1, mlu_device)
    model_2, hook_2 = cpu_offload_with_hook(model_2, mlu_device, prev_module_hook=hook_1)
    model_3, hook_3 = cpu_offload_with_hook(model_3, mlu_device, prev_module_hook=hook_2)
