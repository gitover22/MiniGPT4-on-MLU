...
class GradScalerKwargs(KwargsHandler):
    ...
    `torch.mlu.amp.GradScaler` used is created. Please refer to the documentation of this
...
class DynamoBackend(str, enum.Enum):
    ...
    Values:
        ...
        - **INDUCTOR** -- Uses TorchInductor backend with AotAutograd and mlugraphs by leveraging codegened Triton
          kernels. [Read
        ...
        - **AOT_NVFUSER** -- nvFuser with AotAutograd. [Read
          more](https://dev-discuss.pytorch.org/t/tracing-with-primitives-update-1-nvfuser-and-its-primitives/593)
        - **AOT_CUDAGRAPHS** -- mlugraphs with AotAutograd. [Read
